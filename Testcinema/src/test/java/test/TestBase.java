...
public class TestBase {
    ...
    String phoneCustomer2;
    String passwordCustomer2;
    String phoneCustomer3;
    String passwordCustomer3;
    ...
    String employee2Phone;
    String employeePhoneForPair;
    String employeePassword;
    String ticketCode;

    String nguyenManager;
    String nguyenEmployee;
    String nguyenLeTan;
    ...
    public void setUp() throws MalformedURLException {
        ...
        desiredCapabilities.setCapability(AndroidMobileCapabilityType.APP_PACKAGE, "com.example.sonthach.phim");
